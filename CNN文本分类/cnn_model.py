...
class TCNNConfig(object):
    ...
    embedding_dim = 64  # 词向量维度  embedding: 嵌入
    seq_length = 600  # 序列长度
    num_classes = 10  # 类别数
    ...
    dropout_keep_prob = 0.5  # dropout保留比例   0.3比0.5准确率高
...
class TextCNN(object):
    ...
    def cnn(self):
        ...
        with tf.name_scope("accuracy"):
            ...
            # tf.cast()将correct_pred T/F转化成tf.float32类型1/0
